...
namespace TAO_SCV_Ready_v_05.Controllers
{
    ...
    {
        private readonly TAOContext _dbContext;

        public HomeController()
        {
            _dbContext = new TAOContext();
        }
        ...
        {
            _dbContext.HourlyReadings.ToList();
            return View();
        }
        ...
        public async Task<ActionResult> ImportFile(HttpPostedFileBase importFile)
        {
            ...
            try
            {
                ...
                foreach (var s in hr)
                {
                    _dbContext.HourlyReadings.Add(s);

                }
                //hr.ForEach(s => _dbContext.HourlyReadings.Add(s));
                _dbContext.SaveChanges();
                int i = _dbContext.HourlyReadings.Count();
